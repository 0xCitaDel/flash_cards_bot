...
class MainBebrisHandler:
    ...
    async def select_lesson(
        self, callback: CallbackQuery, widget: Select, manager: DialogManager, item_id
    ):
        """
    ...
    async def initialize_lesson_from_input(
        self,
        message: Message,
    ...
    async def show_all_cards(
        self, callback: CallbackQuery, widget: Button, manager: DialogManager
    ):
        """
    ...
    async def _initialize_lesson_data(self, manager: DialogManager, item_id: int):
        """
